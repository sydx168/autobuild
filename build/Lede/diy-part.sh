...
export Op_name="Tong"                # 修改主机名称为OpenWrt-123(填0为不作修改)
...
export DNS_Settings="10.10.10.3"                     # 旁路由设置 DNS(填入DNS，多个DNS要用空格分开)(填0为不作修改)
...
export Customized_Information="才子佳人_怡人自得$(TZ=UTC-8 date "+%Y.%m.%d")"  # 个性签名,你想写啥就写啥，(填0为不作修改)
